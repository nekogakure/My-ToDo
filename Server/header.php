...
// セッションからuserNameを取得し、ユーザー名を設定
$username = isset($_SESSION['userName']) ? htmlspecialchars($_SESSION['userName']) : '<a href="https://mytodo.f5.si/seikyo" style="text-decoration: none; color: #fff">Login</a>';
